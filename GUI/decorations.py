...
def creer_cadre(
    ...
    cadre.append(
        canvas.create_oval(
            ((coord[0], coord[1]), (coord[0] + 2 * rayon_coins, coord[1] + 2 * rayon_coins)), 
            fill=couleur, 
            outline=couleur, 
            tags=tag
        )
    ...
    cadre.append(
        canvas.create_oval(
            ((coord[0] + largeur - 2 * rayon_coins, coord[1]), 
    ...
    cadre.append(
        canvas.create_oval(
            ((coord[0] + largeur - 2 * rayon_coins, coord[1] + hauteur - 2 * rayon_coins), 
    ...
    cadre.append(
        canvas.create_oval(
            ((coord[0], coord[1] + hauteur - 2 * rayon_coins), 
